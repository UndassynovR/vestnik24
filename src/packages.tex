...
\setlength{\cftbeforetoctitleskip}{-1.5em} % Space before the TOC title
\setlength{\cftaftertoctitleskip}{0.5em} % Space after the TOC title
...
\renewcommand{\cftpartfont}{\itshape\bfseries}
...
\newcommand{\envelope}{\textsuperscript{\includegraphics[width=1em]{envelope}}}
