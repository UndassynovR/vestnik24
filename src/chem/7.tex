...
\centering
\begin{tabular}{|>{\centering\arraybackslash}p{0.2\textwidth}|>{\centering\arraybackslash}p{0.2\textwidth}|}
\hline
...
\emph{3.3 Результаты балансовых опытов.} В ходе исследований было проведено
...
\multicolumn{1}{|p{0.2\textwidth}|}{Теплота сгорания, низшая} & \multicolumn{1}{l|}{Qн} & \multicolumn{3}{l|}{5752,81, ккал/кг} \\ \hline
\multicolumn{1}{|p{0.2\textwidth}|}{Теплота сгорания, высшая} & \multicolumn{1}{l|}{Qв} & \multicolumn{3}{l|}{5983,14, ккал/кг} \\ \hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{|l|p{0.12\textwidth}|c|}
\hline
