...
\begin{table}[]
    \centering
    {\bfseries Table 1−Test development programs} \\[10pt] % Adjust the space here, e.g., 10pt for a small gap
    ...
    Examiner & Practically no different from TestMaker                                                           \\ \hline
    MyTestXPro &
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width=0.9\textwidth]{assets/126}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/127}
