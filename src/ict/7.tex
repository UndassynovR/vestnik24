...
\hline
4 & Eavesdropping {[}13{]} & In an eavesdropping attack, an attacker is
...
\begin{longtable}[H]{|@{}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0752}}|
...
\begin{longtable}[H]{|@{}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0475}}|%
