...
\caption*{Table 1 - Most common attacks on WSN} \\
\hline
...
between remote nodes. & Data loss. Network segment-ation. Resource
...
\hline
2 & The man in the middle attack {[}10{]} & Man-in-the-middle attack
...
\hline
3 & Sibyl {[}12{]} & Sybil attack involves creating a network of malicious
...
\hline
4 & Eaves-dropping {[}13{]} & In an eavesdropping attack, an attacker is
...
\caption*{Table 2 - Full-scale experiments to detect attacks and their results}\\
\hline
